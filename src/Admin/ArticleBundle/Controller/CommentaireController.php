...
class CommentaireController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $commentaires = $em->getRepository('AdminArticleBundle:Commentaire')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Admin\ArticleBundle\Form\CommentaireType', $commentaire);
    ...
    {
        $deleteForm = $this->createDeleteForm($commentaire);
        $editForm = $this->createForm('Admin\ArticleBundle\Form\CommentaireType', $commentaire);
